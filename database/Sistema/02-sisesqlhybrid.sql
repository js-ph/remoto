...
1 = Nuevo usuario
0 = El usuario ya hizo login', Usuario varchar(50), contrasena varchar(150), correo_electronico varchar(255), fecha_de_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP, fecha_de_modificacion time, status int(10), ultimo_login TIMESTAMP, idGrupo int(10), PRIMARY KEY (idUsuario));
